@extends('layouts.app', ['activePage' => 'transactions.daily_closing_detail', 'titlePage' => __('Cierre Diario Detalle')])
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="card card-stats ds8initiated">
          <div class="card-header card-header-warning card-header-icon">
            ...
            <h3 class="card-title">$621.44
            </h3>
          </div>
          <div class="card-footer">
            <div class="stats">
              <h2><span>Transacciones: 6</span></h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card tables">
          ...
          <div class="card-body">
            <h4 class="card-title">Cierre Diario Detalle</h4>
            <div class="table-responsive">
              <table class="table" id="daily_closing_detail_table" style="position: relative; white-space: nowrap">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#daily_closing_detail_table thead tr').clone(true).appendTo('#daily_closing_detail_table thead');
    $('#daily_closing_detail_table thead tr:eq(1) th').each(function (i) {
      var title = $(this).text();
...
//    });
    ...
    var table = $('#daily_closing_detail_table').DataTable({
      ...
      serverSide: false,
      ajax: {
        url: relative_path + "/ajax-daily-closing-detail-get-all",
        type: 'POST',
      ...
      columns: [
        ...
        {data: 'office', title:"Sucursal", searchable: true},
