@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Global Connection - Dashboard')])
      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            ...
            <img class='img-responsive logoicon' src='{{ asset('material') }}/img/logoicon.png'/>
          </div>
          <div class="card-body">
