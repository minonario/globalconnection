@extends('layouts.app', ['activePage' => 'config.blacklistemail', 'titlePage' => __('Lista Negra de Email')])
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card tables">
          ...
          <div class="card-body">
            <h4 class="card-title">Lista Negra de Email</h4>
            <div class="table-responsive">
              <table class="table table-striped" id="blacklistemail_table" style="position: relative; width: 100%; white-space:nowrap;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#blacklistemail_table thead tr').clone(true).appendTo('#blacklistemail_table thead');
        $('#blacklistemail_table thead tr:eq(1) th').each(function (i) {
            var title = $(this).text();
        ...
        var table = $('#blacklistemail_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: relative_path+"/ajax-blacklistemail-get-all",
                type: 'POST',
