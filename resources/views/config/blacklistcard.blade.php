@extends('layouts.app', ['activePage' => 'config.blacklistcard', 'titlePage' => __('Lista Negra de Tarjeta')])
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card tables">
          ...
          <div class="card-body">
            <h4 class="card-title">Lista Negra de Tarjeta</h4>
            <div class="table-responsive">
              <table class="table table-striped" id="blacklistcard_table" style="position: relative; width: 100%; white-space:nowrap;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#blacklistcard_table thead tr').clone(true).appendTo('#blacklistcard_table thead');
        $('#blacklistcard_table thead tr:eq(1) th').each(function (i) {
            var title = $(this).text();
        ...
        var table = $('#blacklistcard_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: relative_path+"/ajax-blacklistcard-get-all",
                type: 'POST',
