@extends('layouts.app', ['activePage' => 'config.blacklistip', 'titlePage' => __('Lista Negra de IP')])
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card tables">
          ...
          <div class="card-body">
            <h4 class="card-title">Lista Negra de IP</h4>
            <div class="table-responsive">
              <table class="table table-striped" id="blacklistip_table" style="position: relative; width:100%; white-space:nowrap;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#blacklistip_table thead tr').clone(true).appendTo('#blacklistip_table thead');
        $('#blacklistip_table thead tr:eq(1) th').each(function (i) {
            var title = $(this).text();
        ...
        var table = $('#blacklistip_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: relative_path+"/ajax-blacklistip-get-all",
                type: 'POST',
